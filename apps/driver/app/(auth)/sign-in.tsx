...
export default function SignInScreen() {
  ...
  return (
    <View className="flex-1 bg-background px-6 justify-center">
      <Text className="font-poppins-bold text-3xl text-primary mb-2">Driver Portal</Text>
      <Text className="text-secondary font-inter mb-8">Sign in to start delivering</Text>
      <TextInput
